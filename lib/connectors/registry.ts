...
const internalAirtableManifest: ConnectorManifest = {
  ...
  description: "Creates one record through the isolated connector runner after an explicit successful verification test.",
  status: "BETA",
  version: 1,
  auth: {
    type: "api_key",
  ...
  limitations: [
    "LIVE execution requires an owned customer connection verified by a successful create-record test.",
