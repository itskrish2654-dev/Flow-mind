...
export default function TermsPage() {
  ...
  return (
    <LegalPageShell eyebrow="Legal" title="Terms of Service" description="The basic terms for using CrazyLoops.">
      <section><h2>Agreement</h2><p className="mt-3">These Terms apply when you create an account or use CrazyLoops. By using the service, you agree to follow them.</p></section>
      ...
      <section><h2>Disclaimers and liability</h2><p className="mt-3">CrazyLoops is an evolving service provided “as is” and “as available.” We do not promise that every feature will always be available, uninterrupted, or error-free. To the extent permitted by applicable law, CrazyLoops is not responsible for indirect or consequential losses resulting from use of the service. Nothing in these Terms limits rights that cannot legally be limited.</p></section>
