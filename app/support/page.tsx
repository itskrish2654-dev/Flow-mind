...
export const metadata: Metadata = {
  title: "Support",
  description: "Get help with CrazyLoops accounts, workflows, privacy, and security.",
  alternates: { canonical: "https://crazyloops.com/support" },
};

export default function SupportPage() {
  const supportEmail = getSupportEmail();
  return (
    <LegalPageShell eyebrow="Help" title="CrazyLoops Support" description="Where to get help with accounts, workflows, data requests, and security reports.">
      <section><h2>Contact</h2>{supportEmail ? <p className="mt-3">Support contact: <a href={`mailto:${supportEmail}`}>{supportEmail}</a></p> : <p className="mt-3">The public support contact is being finalized. Owner action is required before Google submission.</p>}<p className="mt-2">When reporting a problem, include what you expected, what happened, and the approximate time. Do not send passwords, API keys, CAPTCHA tokens, recovery links, or private credentials.</p></section>
