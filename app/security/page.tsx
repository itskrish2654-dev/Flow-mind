...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://crazyloops.com/security" },
};
...
export default function SecurityPage() {
  ...
  return (
    <LegalPageShell eyebrow="Trust" title="Security at CrazyLoops" description="A concise, truthful overview of safeguards currently used by the product. No system is perfectly secure.">
      ...
      <section><h2>Responsible reporting</h2><p className="mt-3">Please do not access or modify data that is not yours, disrupt service, or publish sensitive findings before remediation. {supportEmail ? <>Report a suspected vulnerability to <a href={`mailto:${supportEmail}`}>{supportEmail}</a>.</> : <>A public security contact is being finalized and requires owner configuration before Google submission.</>}</p></section>
